...
export function Toast({ message, type = 'success', onClose, duration = 3000 }: ToastProps) {
  ...
  return (
    <div 
      className={`fixed bottom-7 right-7 ${bgColor} text-white rounded-lg px-5 py-[13px] font-display font-bold text-sm shadow-[0_8px_28px_rgba(26,107,46,0.35)] z-[999] flex items-center gap-2 max-w-[340px]`}
